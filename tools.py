...
def generic(**kwargs):
    """Este é um modelo de linguagem genérico que pode responder a qualquer pergunta sobre não tratada por nenhuma outra ferramenta fornecida. Você deve responder de acordo com o documento/contrato a seguir somente. Caso ela lhe questione a respeito de algo fora do contrato não responda. Assuma que o usuário já recebeu o acordo, instruções para assinatura e o boleto para pagemento, e portanto ela só quer informações sobre o contrato. Se ela precisar que envie novamente o acordo, ela pedirá. Por isso não invoca nenhuma outra ferramenta após, sem que seja necessário.
